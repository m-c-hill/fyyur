INSERT INTO venue (name, city, state, address, phone, image_link, genres, facebook_link, website_link, seeking_talent, seeking_description)
VALUES
...
INSERT INTO artist (name, genres, city, state, phone, facebook_link, website_link, seeking_venue, seeking_description, image_link)
VALUES
...
('Matt Quevedo', ARRAY ['Jazz'], 'New York', 'NY', '300-400-5000', 'https://www.facebook.com/mattquevedo923251523', Null, False, Null, 'https://images.unsplash.com/photo-1495223153807-b916f75de8c5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80'),
('The Wild Sax Band', ARRAY ['Jazz', 'Classical'], 'San Francisco', 'CA', '432-325-5432', Null, Null, False, Null, 'https://images.unsplash.com/photo-1558369981-f9ca78462e61?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=794&q=80');
